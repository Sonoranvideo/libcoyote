...
PYBIND11_MODULE(pycoyote, ModObj)
{
	...
	EMEMDEF(COYOTE_RES_1080PSF)
	EMEMDEF(COYOTE_RES_2160P)
	EMEMDEF(COYOTE_RES_2160PSF)
	EMEMDEF(COYOTE_RES_DCI_2048)
	EMEMDEF(COYOTE_RES_DCI_2048PSF)
	EMEMDEF(COYOTE_RES_DCI_4096)
	EMEMDEF(COYOTE_RES_DCI_4096PSF)
	...
	EMEMDEF(COYOTE_UTYPE_SERVER_Q3G)
	EMEMDEF(COYOTE_UTYPE_SERVER_D12G)
	EMEMDEF(COYOTE_UTYPE_SERVER_Q12G)
	...
	ACLASSF(Session, LoadNetSettings)
	...
	ACLASSF(Session, ManualAddAsset)
	ACLASSF(Session, ManualForgetAsset)
